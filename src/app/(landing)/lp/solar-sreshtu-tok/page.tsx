...
export const metadata: Metadata = {
  title: "Соларна Енергия vs Мрежов Ток | Solaron",
  description:
    "Цените на тока растат — соларните спестявания могат да нараснат заедно с тях. Сравнение на тенденциите и 25-годишна ориентировъчна прогноза на разходите.",
};

export default function SolarSreshtuTokPage() {
  return (
    <>
