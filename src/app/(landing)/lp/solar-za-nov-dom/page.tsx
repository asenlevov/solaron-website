...
export const metadata: Metadata = {
  title: "Соларна Система за Нов Дом | Solaron",
  description:
    "Планирате нов дом? Включете соларна система още при проектиране — по-добра цена, интегриран дизайн и максимална ефективност с Solaron.",
};
...
export default function SolarZaNovDomPage() {
  return (
    <>
        ...
        <div className="relative mx-auto max-w-7xl px-6 pb-16 pt-14 md:px-8 md:pb-24 md:pt-20 lg:pb-28 lg:pt-24">
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            <Button variant="primary" size="lg" asChild>
              <Link href="#kontakt">Заявка за оферта</Link>
            </Button>
            ...
            >
              ...
              <div className="mt-6 flex flex-1 flex-col justify-end">
                <Button variant="primary" className="w-full" asChild>
                  <Link href="#kontakt">Искам оферта</Link>
                </Button>
              </div>
            </Card>
          ))}
