...
export const metadata: Metadata = {
  title: "Финансиране на Соларни Панели | Solaron",
  description:
    "Соларна система без голяма начална инвестиция: банков кредит, лизинг и разсрочено плащане. Сравнете срока на изплащане чрез спестявания от ток.",
};
...
export default function FinansiraneSolarPage() {
  return (
    <>
        ...
        <div className="relative mx-auto max-w-7xl px-6 pb-16 pt-14 md:px-8 md:pb-24 md:pt-20 lg:pb-28 lg:pt-24">
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            <Button variant="primary" size="lg" asChild>
              <Link href="#kontakt">Говорете с експерт</Link>
            </Button>
