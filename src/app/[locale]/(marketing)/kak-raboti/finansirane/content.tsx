...
const BANK_PRODUCTS = [
  {
    ...
    term: "до 10 години",
    downPayment: "0–10%",
    note: "За системи до 30 kW. Без обезпечение до 25 500 €.",
  },
  {
...
const BANK_REQUIREMENTS = [
  "Стабилен месечен доход (мин. 770 € нетно)",
...
const FAQS = [
  ...
  },
  {
    ...
    a: "Повечето банки изискват нетен месечен доход от поне 770 € за потребителски кредит. За бизнес кредити се анализират годишните финансови отчети и оборотът на фирмата.",
  },
  {
    ...
    <main className="overflow-hidden">
      ...
      <section className="relative bg-foreground px-6 py-24 text-white md:py-32">
        ...
        <div className="relative z-10 mx-auto max-w-7xl">
          ...
          >
            Ориентировъчно сравнение за 10 kWp система на стойност ~10 200 €.
