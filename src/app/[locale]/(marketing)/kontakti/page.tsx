          ...
          <div className="grid gap-12 lg:grid-cols-5 lg:gap-16">
            ...
            <aside className="lg:col-span-2">
              <div className="sticky top-28 space-y-8">
                ...
                {/* Call — the one contact channel we can prove answers */}
                <a
                  href={PHONE_HREF}
                  className="flex items-center gap-4 rounded-2xl border border-accent/20 bg-accent/5 p-6 transition-colors hover:bg-accent/10"
                >
                  <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-full bg-accent">
                    <Phone className="h-6 w-6 text-white" strokeWidth={1.75} aria-hidden />
                  </div>
                  <div>
