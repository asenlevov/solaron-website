...
const allProducts = [
  { id: "solarni-paneli", title: "Соларни Панели", href: "/produkti/solarni-paneli", img: PRODUCT_IMAGES.solarPanel },
  { id: "invertori", title: "Инвертори", href: "/produkti/invertori", img: PRODUCT_IMAGES.inverter },
  { id: "baterii", title: "Батерии", href: "/produkti/baterii", img: PRODUCT_IMAGES.battery },
  { id: "ev-zaryadni", title: "EV Зарядни Станции", href: "/produkti/ev-zaryadni-stantsii", img: PRODUCT_IMAGES.evCharging },
  { id: "konstrukcii", title: "Конструкции", href: "/produkti/konstrukcii", img: PRODUCT_IMAGES.constructions },
  { id: "monitoring", title: "Мониторинг", href: "/produkti/monitoring", img: PRODUCT_IMAGES.monitoring },
];

export function ProductPageProjects() {
