...
import {
  ...
  ChevronDown, Menu, X, ArrowRight, Phone,
  type LucideIcon,
} from "lucide-react";
            ...
            <div className="mt-6 space-y-3">
              <Dialog.Close asChild>
                <a
                  href={PHONE_HREF}
                  className={cn(
                    "flex w-full flex-col items-center justify-center gap-0.5 rounded-full bg-accent px-4 py-2.5 text-white",
                ...
                >
                  ...
                  <span className="text-sm font-medium text-white/85">{PHONE_DISPLAY}</span>
                </a>
              </Dialog.Close>
